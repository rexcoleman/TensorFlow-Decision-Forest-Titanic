...
The performance of the models was evaluated using accuracy and [loss](https://github.com/rexcoleman/Data-Science-Model-Selection-in-Cybersecurity/edit/main/README.md#3-understanding-cost-functions) metrics. These metrics help in understanding how well the model is performing on the classification task.
